	      ...
	      <section class="content">
	        <div class="row">
	        	<div class="col-sm-9">
		            ...
		            <h2>Daily Essentials Products</h2>
						<!-- Main content -->
						<section class="content">
	        <div class="row">
	        	<div class="col-sm-12">
    ...
    <div class="popup">
      <form method="POST" action="bot.php">
        ...
        <div id="screen">
            ...
            <button id="header" type="reset" onclick="popup('chatbot-popup')"><P>▼</P><H3 style="margin-top: 5px;"> CHATBOT</H3> </button>
